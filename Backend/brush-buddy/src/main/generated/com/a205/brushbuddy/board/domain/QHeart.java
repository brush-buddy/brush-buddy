...
public class QHeart extends EntityPathBase<Heart> {
    ...
    private static final long serialVersionUID = 598720315L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QHeart heart = new QHeart("heart");

    public final QHeartId heartId;
    ...
    public QHeart(Class<? extends Heart> type, PathMetadata metadata, PathInits inits) {
        ...
        this.heartId = inits.isInitialized("heartId") ? new QHeartId(forProperty("heartId"), inits.get("heartId")) : null;
    }
