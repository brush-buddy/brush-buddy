...
public interface BoardService {
    Page<Board> getBoardList(String search, Pageable pageable) throws Exception; // 게시판 리스트 조회 및 검색 조회
    ...
    Page<Reply> getReplies(Long BoardId, Pageable pageable) throws Exception; // 댓글 목록 조회
