...
public interface PaletteService {
    List<Palette> getPaletteList(Integer userId, String order, Pageable pageable); //팔레트 리스트 조사하기
    Palette getPaletteDetail(Integer userId, Long paletteId); // 팔레트 상세 조회

    boolean duplicatePalette(Integer userId, Long paletteId); // 팔레트 복제 성공시 true
